...
\begin{enumerate}
  ...
  \item Ein Random Non-Dense-case, in welchem ein Zufälliger Graphen erstellt
  wurde auf folgender weise: Es wird ein neuer Knoten erstellt und
  ...
  10 Messung durchgeführt und das Maximum genommen. Siehe Figur 3.
