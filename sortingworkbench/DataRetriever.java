...
public class DataRetriever
{
	 ...
	 */
	public List<Integer> createPartiallyOrderedIntegerList(int numElements,
		int partialOrderedSize)
	{
	 ...
	 */
	public List<Integer> createIntegerList(SortingMetrics.ListType listType,
		int numElements)
	{
