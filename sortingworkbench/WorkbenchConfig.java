...
public class WorkbenchConfig {
    ...
    public WorkbenchConfig(List<Sorter> sorter, int numRuns, int elementsStart, int elementsIncrement, int partialOrderedListSize) {
    ...
    public RunInfo getNextRunConfig() {
        currentRun++;
        runs[currentRun] = new RunInfo(this.sorter, currentRun * elementsIncrement + elementsStart, this.partialOrderedListSize);
